    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
        ...
        <li class="sidebar-brand"><a href="http://startbootstrap.com"><?= $top_title ?></a></li>
    ...
    <div id="top" class="header">
      <div class="vert-text">
        <h1 class="editable" data-id="top_title"><?= $top_title ?></h1>
        <h3 class="editable" data-id="top_slogan"><?= $top_slogan ?></h3>
        <a href="#about" class="btn btn-default btn-lg editable" data-id="top_button">Find Out More</a>
      </div>
    </div>
    <!-- /Full Page Image Header Area -->
