...
<html lang="en">
  ...
  <body>
    ...
    <div id="top" class="header">
      <div class="vert-text">
        <h1 class="editable" data-id="top_title">Start Bootstrap</h1>
        <h3 class="editable" data-id="top_slogan"><em>We</em> Build Great Templates, <em>You</em> Make Them Better</h3>
